...
function bubbleChart() {
  ...
  var stateCenters = {
    ...
    AS: { x: width / 3, y: 2* height / 3 },
    EE: { x: 3 * width / 8, y: height / 3 },
    LA: { x: width / 2, y: 2* height / 3 },
    ME: { x: 5 * width / 8, y: height / 3 },
    NA: { x: 2 * width / 3, y: 2* height / 3 },
    WE: { x: 13 * width / 16, y: height / 3 }
  }
  ...
  var stateTitle = {
    ...
    AS: { x: 9 * width / 40, y: 9 * height / 20 },
    EE: { x: 7 * width / 20, y: height / 8 },
    LA: { x: width / 2, y: 9 * height / 20 },
    ME: { x: 13 * width / 20, y: height / 8 },
    NA: { x: 31 * width / 40, y: 9 * height / 20 },
    WE: { x: 9 * width / 10, y: height / 8 }
  }
